...
insert into students(first_name, last_name, birth_date)
values	('Meyanui', 'Valentine', '1986/11/11');
...
SELECT * 
FROM students 
WHERE first_name LIKE '%a%'; --The LIKE operator is used to match a specified pattern within a string.
...
SELECT * 
FROM students 
WHERE first_name iLIKE 'a%'; -- ilike makes it case insensitive
