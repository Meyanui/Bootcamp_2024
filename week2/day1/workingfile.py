...
# user_number = float(input("\nKindly enter a number between 1 and 100: \n"))
# if user_number < 1 or user_number > 100:
#     print("The figure entered is out of place. Please Enter the correct number")
# else:
...
#     print("Buzz")
#   else:
#     print(f"{user_number} is neither a multiple of 3 nor 5\n")


    # Loops
#     # For:

# Hobbies = {"Eat", "Sleep", "Music", "Soccer", "Hiking"}
# for Music in Hobbies:
#   print(f"\nThese are the things I enjoy: {Music}")
...
#     current_number += 1 # this condition breaks or stops when it is met
#********************************************************************************

# #RANGE FUNCTION - it is a type of FOR Loop
# numbers = range(4, 19)
...
# STEP = used as the third value in a RANGE = addition
numbers = range(4, 60, 10)
...
user_number = int(input("Write down any number of your choice: "))
